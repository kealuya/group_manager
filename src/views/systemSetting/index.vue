  ...
  <div class="app-container">
    <div class="header">
      <el-form :inline="true" :model="formInline" class="demo-form-inline" ref="ruleFormRef">
        <el-form-item label="员工名称" prop="roleName">
          <el-input v-model="formInline.roleName" placeholder="请输入员工名称"/>
        </el-form-item>
        <el-form-item>
    ...
    <div class="footer">
      ...
      <div class="table-inner">
        <el-table
          ...
          <el-table-column prop="staffNumber" label="工号" />
          ...
          <el-table-column prop="waitHandle" label="待处理事项（个）" />
          <el-table-column prop="overHandle" label="已处理事项（个）" />
...
const changeStatus = (row) => {
  ElMessageBox.confirm(
    `确定要${!row.status ? '禁用' : '启用'} ${row.roleName} 员工吗？`,
    '温馨提示',
    {
      confirmButtonText: '确定',
      cancelButtonText: '取消',
